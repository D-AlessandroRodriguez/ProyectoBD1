...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Registrar entrada extraordinaria</title>
	...
	<body>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse mx-2" id="navbarNavDropdown">
			      <ul class="navbar-nav d-flex gap-2">
			        ...
			        <li class="nav-item dropdown">
			          ...
			          <ul class="dropdown-menu">
			            <li><a class="dropdown-item active" id="registrarEntradaExtraordinariaMenu" href="#">Registrar entrada extraordinaria</a></li>
			    ...
			    <div>
			    	<ol class="breadcrumb mb-0">
				    	...
				    	<li class="breadcrumb-item active" aria-current="page">Registro de entrada extraordinaria</li>
				    </ol>
			    </div>
			</div>
		</nav>
		...
		<div id="contenedorPrincipal" class="container">
			<div id="tituloRowContainer" class="row">
				<h3 class="pt-3">Registro de devolución de producto</h3>			
			</div>
