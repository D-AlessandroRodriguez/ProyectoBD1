...
<html>
	...
	<body>
		<div id="loginBox" class="shadow-lg">
			...
			<br>
			<form id="form" action="session" class="d-grid mx-auto col-9 mt-3">
				<input type="email" name="email" id="emailInput" class="shadow custom-input form-control rounded-5" id="exampleFormControlInput1" placeholder="Correo electrónico">
		...
		<script src="assets/login/bootstrap/bootstrap.bundle.min.js"></script>
	</body>
</html>